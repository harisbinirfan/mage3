 ...
 */
class Tejar_Catalog_Helper_Category_Image extends Mage_Core_Helper_Abstract
{
     ...
     * @return Mage_Catalog_Helper_Image
     */
    public function init(Mage_Catalog_Model_Category $product, $attributeName, $imageFile=null)
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('tejar_catalog/category_image'));
