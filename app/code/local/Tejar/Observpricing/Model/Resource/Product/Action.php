 ...
 */
class Tejar_Observpricing_Model_Resource_Product_Action extends Mage_Catalog_Model_Resource_Product_Action
{
    /**
     ...
     */
    public function updateAttributesArray($entityIds, $attrData, $storeId)
    {
        ...
        try {
            foreach ($attrData as $attrCode => $value) {
                ...
                foreach ($entityIds as $entityId) {
                    ...
                    $this->_saveAttributeValue($object, $attribute, $value[$entityId]);
                    }
