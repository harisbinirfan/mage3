 ...
 */
class Tejar_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config_Simple
    extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config_Simple
{
    ...
    protected function _prepareForm()
    {
        ...
        $attributesConfig = array(
            ...
            'additional'   => array('name', 'sku', 'visibility', 'status', 'weight'),
			'default_values' => array('status', 'weight')
        );
        ...
        foreach ($attributes as $attribute) {
            if (($attribute->getIsRequired()
				...
				if (in_array($attributeCode, $attributesConfig['default_values'])) {
                    $element->setValue($this->_getProduct()->getData($attributeCode));
                }
