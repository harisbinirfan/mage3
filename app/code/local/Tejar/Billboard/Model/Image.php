 ...
 */
class Tejar_Billboard_Model_Image extends Mage_Catalog_Model_Product_Image
{
   ...
   /**
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getBaseDir('media') . DS . 'billboard' . DS . 'image';
        ...
        if (!$file) {
				...
				if ($isConfigPlaceholder && $this->_fileExists($baseDir . $configPlaceholder)) {
					...
					$skinPlaceholder = "/images/billboard/image/placeholder/thumbnail.jpg";
        ...
        $path = array(
			Mage::getBaseDir('media') . DS . 'billboard' . DS . 'image',
            'cache',
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'billboard'.DS.'image'.DS.'cache'.DS;
