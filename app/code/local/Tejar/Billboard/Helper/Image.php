...
class Tejar_Billboard_Helper_Image extends Mage_Core_Helper_Abstract
{
   ...
   /**
     ...
     * @return Mage_Catalog_Helper_Image
     */
    public function init(Itactica_Billboard_Model_Unit $product, $attributeName, $imageFile=null)
    {
        ...
        $this->_reset();
        $this->_setModel(Mage::getModel('tejar_billboard/image'));
